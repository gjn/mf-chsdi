                ...
                children: [
                   {
                        ...
                        children: [
                            {
                                text: this.addtreeLayerLink("ch.swisstopo.vec25-gewassernetz", "node_ch.swisstopo.vec25-gewassernetz1") + ' ' + this.layers["ch.swisstopo.vec25-gewassernetz"].name,
                                leaf: true,
                                checked: false,
                                cls: 'nodeLT3',
                                id: "node_ch.swisstopo.vec25-gewassernetz1"
                            }
                        ]
                    },
                    /*{
