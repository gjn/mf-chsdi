...
// custim layer node UI class, for use with the first tree
GeoExt.examples.LayerNodeUI1 = Ext.extend(
    Ext.extend(
        Ext.extend(
    ...
    new GeoExt.tree.ComponentMixin()
);

// a custom layer node UI class, for use with the second tree
GeoExt.examples.LayerNodeUI2 = Ext.extend(GeoExt.examples.LayerNodeUI1, {
    actions: [{
        action: "delete",
        qtip: "delete"
    }, {
...
Ext.onReady(function() {
    ...
    // component are set using the loader's "baseAttrs" property. FIXME
    var tree1 = new Ext.tree.TreePanel({
        ...
        loader: {
            applyLoader: false,
            uiProviders: {
                "ui": GeoExt.examples.LayerNodeUI1
            }
        },
        root: {
    ...
    // class is used for each node of the layer container. FIXME
    var tree2 = new Ext.tree.TreePanel({
        ...
        root: {
            ...
            loader: {
                uiProviders: {
                    "ui": GeoExt.examples.LayerNodeUI2
                },
                baseAttrs: {
                    uiProvider: "ui",
                    radioGroup: "radiogroup"
