...
function init() {
    ...
    OpenLayers.ProxyHost = (window.location.host == "localhost") ? "/ogcproxy?url=" : "/ogcproxy?url=";

    OpenLayers.Request.GET({
        url: data, //"http://api.geo.admin.ch/1.0.0/WMTSCapabilities.xml",
        ...
        success: function(request) {
            ...
            log("Loading GetCapabilities from " + data);
            log("Got document");
