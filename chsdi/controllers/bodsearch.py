...
class BodsearchController(BaseController):
    ...
    def search(self):
        ...
        query = Session.query(self.BodLayer).order_by(self.BodLayer.bezeichnung).order_by(self.BodLayer.kurzbezeichnung).order_by(self.BodLayer.geobasisdatensatzname)
