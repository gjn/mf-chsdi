...
<%def name="table_body()">
    ...
    % elif c.feature.ak == 'TI':
        <tr><td width="150">${_('link to canton geoportal')}</td><td><a href="http://www.sitmap.ti.ch/index.php?ct=mue&extent=${','.join(map(str,c.extent.bounds))}" target="_blank">TI</a></td></tr>
    ...
    % elif c.feature.ak == 'NE':
        <tr><td width="150">${_('link to canton geoportal')}</td><td><a href="http://sitn.ne.ch/theme/cadastre?map_x=${c.bbox[0]}&map_y=${c.bbox[1]}&map_zoom=12" target="_blank">NE</a></td></tr>
