...
<%
  Key_To_Translate_85 = 'bfs_noas04_' + str(c.feature.id_arealstatistik_85)
  Key_To_Translate_97 = 'bfs_noas04_' + str(c.feature.id_arealstatistik_97)
  Key_To_Translate_09 = 'bfs_noas04_' + str(c.feature.id_arealstatistik_09)
%>
    <% c.stable_id = True %>
