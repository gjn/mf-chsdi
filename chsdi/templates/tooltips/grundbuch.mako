...
<%def name="table_body()">
    ...
    <tr><td width="150" valign="top">${_('grundgemeinde')}</td>    <td>${c.feature.ortsteil_grundbuch or '-'}</td></tr>
    % endif
    ...
    <tr><td width="150">${_('grundurl')}</td>    <td><a href="mailto:${c.feature.email}">${_(c.feature.email) or '-'}</a></td></tr>
    % endif
</%def>
