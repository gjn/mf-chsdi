...
<%def name="table_body()">
       ...
       <tr><td width="150">${_('fp_Y03_X03')}</td><td>${c.feature.e_lv03 or '-'} / ${c.feature.n_lv03 or '-'}</td></tr>
       <tr><td width="150">${_('fp_E95_N95')}</td><td>${c.feature.e_lv95 or '-'} / ${c.feature.n_lv95 or '-'}</td></tr>
