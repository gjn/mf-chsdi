...
<%def name="table_body()">
    ...
    <tr><td width="320">${_('id_arealstatistik_97')}</td>      <td>${c.feature.id_arealstatistik or '-'}</td></tr>
    <tr><td width="320">${_('fj97')}</td>                   <td>${c.feature.fj97 or '-'}</td></tr>
    <tr><td width="320">${_('id_arealstatistik_85')}</td>   <td>${c.feature.id_arealstatistik_85 or '-'}</td></tr>
</%def>
